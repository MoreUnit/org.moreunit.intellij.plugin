...
import static org.naounit.intellij.plugin.util.Strings.applySameCapitalization;
import static org.naounit.intellij.plugin.util.Strings.capitalize;
...
public class SubjectFile {
	...
	private static final List<String> COMMON_TEST_PREFIXES_STR = asList("spec", "test", "tests");
	private static final List<String> COMMON_TEST_SUFFIXES_STR = asList("spec", "test", "tests", "should");
	...
	public boolean isCorrespondingFilename(String name) {
		...
		String destName = Files.withoutExtension(name);
		...
		if (srcName.startsWith(".")) {
			...
			srcName = Files.withoutLeadingDot(srcName);
			destName = Files.withoutLeadingDot(destName);
		}
